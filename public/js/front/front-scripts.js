...
function getNominations(disciplina)
{
    ...
    if (this.readyState == 4 && this.status == 200) {
      ...
      {
        var tablica ='<table class="table table-hover bg-light shadow"><thead class="thead"><tr><th>#</th><th>Name and surname</th><th>Team</th><th>Age</th><th>Country</th></tr></thead><tbody>';
        var body = "";
        var i = 0;
      for (var j in odgovori.tezinske_m) {
        body += '<tr><td class="text-center text-light bg-dark" colspan="5">Category:&nbsp;'+ odgovori.tezinske_m[j] + 'kg</td></tr>';
...
{  
  ...
  for (var j in odgovori.tezinske_f) {
    body += '<tr><td class="text-center text-light bg-dark" colspan="5">Category:&nbsp;'+ odgovori.tezinske_f[j] + 'kg</td></tr>';
