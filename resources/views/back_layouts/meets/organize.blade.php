...
<div class="container">
    <div class="row">
        <div class="col-md-10 offset-md-1">
            ...
            <a role="button" class="btn btn-primary gumb m-1" href="#flights" data-bs-toggle="collapse">{{ __('Flights') }}</a>
            @else
  ...
  <div class="col-md-10 offset-md-1">
           <h3 class="text-center mt-3 mb-5">{{ __('Initial Flights Order') }}</h3>
