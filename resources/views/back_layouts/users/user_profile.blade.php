...
$role = "manager";
$live = "da";
echo '<h4 class="text-center"><strong>Za potpuno korištenje platforme molimo vas ispunite vaše korisničke
        podatke</strong></h4>';
}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            @if ($live == "da")
                            <input type="hidden" class="form-control" name="live" value="on">
                            @else
                            <input type="hidden" class="form-control" name="live" value="off">
                            @endif
                        </div>
                        @endif
                        <!-- endif admin -->
